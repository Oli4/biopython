...
__all__ = ['nHmmer3TabParser', 'Hmmer3TabIndexer', 'Hmmer3TabWriter']


class nHmmer3TabParser(object):
    ...
    def _parse_row(self):
        ...
        hit['evalue'] = float(cols[4])              # evalue
        hit['bitscore'] = float(cols[5])            # score
        hit['bias'] = float(cols[6])                # bias
